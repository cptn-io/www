      ...
      <Layout>
         <section>
            <div className="container">
               <div className="legal">
                  <h1 className="has-text-primary">Privacy Policy</h1>
                  <p>Your privacy is important to us. It is DevRaven, Inc.&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://www.cptn.io">https://www.cptn.io</a>, and other sites we own and operate. </p>
                  ...
                  <p>This policy is effective as of 27 May 2022. </p>
                  <p>Last updated: 27 May 2022 </p>
                  <div className="is-size-3 mt-3">Information We Collect</div>
                  ...
                  <div className="is-size-4 mt-3">Log Data</div>
                  ...
                  <div className="is-size-4 mt-3">Device Data</div>
                  ...
                  <div className="is-size-4 mt-3">Personal Information</div>
                  ...
                  <div className="is-size-4 mt-3">Legitimate Reasons for Processing Your Personal Information</div>
                  ...
                  <div className="is-size-4 mt-3">Collection and Use of Information</div>
                  ...
                  <ul>
                     ...
                     <li>Any content you create on our website or a derivative/result of content created by you</li>
                  </ul>
                  ...
                  <div className="is-size-4 mt-3">Security of Your Personal Information</div>
                  ...
                  <div className="is-size-4 mt-3">How Long We Keep Your Personal Information</div>
                  ...
                  <div className="is-size-3 mt-3">Children’s Privacy</div>
                  ...
                  <div className="is-size-3 mt-3">Disclosure of Personal Information to Third Parties</div>
                  ...
                  <div className="is-size-3 mt-3">International Transfers of Personal Information</div>
                  <p>The personal information we collect is stored and/or processed in United States, or where we or our partners, affiliates, and third-party providers maintain facilities. Your content including scripts and any required information may be transmitted, processed and stored in any other locations you choose as monitoring locations. For example: if you choose to run a monitor in Australia, any information required for executing the monitor will be used from our services or servers hosted in Australia.</p>
                  ...
                  <div className="is-size-3 mt-3">Your Rights and Controlling Your Personal Information</div>
                  ...
                  <div className="is-size-3 mt-3">Use of Cookies</div>
                  ...
                  <div className="is-size-3 mt-3">Business Transfers</div>
                  ...
                  <div className="is-size-3 mt-3">Limits of Our Policy</div>
                  <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices. </p>
                  <div className="is-size-3 mt-3">Changes to This Policy</div>
                  ...
                  <div className="is-size-3 mt-3">Additional Disclosures for Australian Privacy Act Compliance (AU)</div>
                  <div className="is-size-4 mt-3">International Transfers of Personal Information</div>
                  ...
                  <div className="is-size-3 mt-3">Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)</div>
                  <div className="is-size-4 mt-3">Data Controller / Data Processor</div>
                  <p>The GDPR distinguishes between organisations that process personal information for their own purposes (known as &ldquo;data controllers&rdquo;) and organizations that process personal information on behalf of other organizations (known as &ldquo;data processors&rdquo;). We, DevRaven, Inc., located at the address provided in our Contact Us section, are a Data Controller with respect to the personal information you provide to us. </p>
                  <div className="is-size-4 mt-3">Legal Bases for Processing Your Personal Information</div>
                  ...
                  <div className="is-size-5 mt-3">Consent From You</div>
                  ...
                  <div className="is-size-5 mt-3">Performance of a Contract or Transaction</div>
                  ...
                  <div className="is-size-5 mt-3">Our Legitimate Interests</div>
                  ...
                  <div className="is-size-5 mt-3">Compliance with Law</div>
                  ...
                  <div className="is-size-4 mt-3">International Transfers Outside of the European Economic Area (EEA)</div>
                  ...
                  <div className="is-size-4 mt-3">Your Rights and Controlling Your Personal Information</div>
                  ...
                  <div className="is-size-3 mt-3">Additional Disclosures for California Compliance (US)</div>
                  ...
                  <div className="is-size-4 mt-3">Do Not Track</div>
                  ...
                  <div className="is-size-4 mt-3">Cookies and Pixels</div>
                  ...
                  <div className="is-size-4 mt-3">CCPA-permitted financial incentives</div>
                  ...
                  <div className="is-size-4 mt-3">California Notice of Collection</div>
                  ...
                  <div className="is-size-4 mt-3">Right to Know and Delete</div>
                  ...
                  <div className="is-size-4 mt-3">Shine the Light</div>
                  ...
                  <div className="is-size-3 mt-3">Contact Us</div>
                  <p>For any questions or concerns regarding your privacy, you may contact us using the following details: </p>
                  <p>DevRaven Support<br />
                     support@devraven.io </p>
