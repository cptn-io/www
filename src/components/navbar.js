        ...
        <div className="navbar-item">
          <div className="buttons">
            ...
            <a href="https://github.com/cptn-io/el-cptn" className="button is-light">
              <span className="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github-filled" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
